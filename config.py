...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/devpika33/Eloramusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Adhoorekhwaab")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/zindagiexpress ")
